! function() {
  "use strict";
  angular.module("BackEndApp", ["BackEndApp.core", /*"BackEndApp.chart", "BackEndApp.ui", "BackEndApp.ui.form", "BackEndApp.ui.form.validation", "BackEndApp.page", "BackEndApp.table",*/ "mgo-angular-wizard", "ui.tree", "ngMap", "textAngular"])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.chart", ["ngecharts"])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.core", ["ngAnimate", "ngAria", "ngMessages", "BackEndApp.layout", /*"BackEndApp.i18n",*/ "ngMaterial", "ui.router", "ui.bootstrap", "duScroll"])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.ui.form", [])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.ui.form.validation", ["validation.match"])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.layout", [])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.page", [])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.table", [])
}(),
function() {
  "use strict";
  angular.module("BackEndApp.ui", ["ngMaterial"])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.chart").controller("EChartsCtrl", ["$scope", "$timeout", e])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.core").factory("appConfig", [e]).config(["$mdThemingProvider", t])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp").controller("AppCtrl", ["$scope", "$rootScope", "$state", "$document", "appConfig", e])
}(),
function() {
  "use strict";
  angular.module("BackEndApp").config(["$stateProvider", "$urlRouterProvider", function(e, t) {
    var a, n;
    a = ["ui/cards", "ui/typography", "ui/buttons", "ui/icons", "ui/grids", "ui/widgets", "ui/components", "ui/timeline", "ui/lists", "ui/pricing-tables", "map/maps", "table/static", "table/dynamic", "table/responsive", "form/elements", "form/layouts", "form/validation", "form/wizard", "chart/echarts", "chart/echarts-line", "chart/echarts-bar", "chart/echarts-pie", "chart/echarts-scatter", "chart/echarts-more", "page/404", "page/500", "page/blank", "page/forgot-password", "page/invoice", "page/lock-screen", "page/profile", "page/signin", "page/signup", "app/calendar"], n = function(t) {
      var a, n;
      return n = "/" + t, a = {
        url: n,
...
function() {
  ...
  angular.module("BackEndApp.i18n", ["pascalprecht.translate"]).config(["$translateProvider", e]).controller("LangCtrl", ["$scope", "$translate", t])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp").controller("DashboardCtrl", ["$scope", e])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.ui.form").controller("InputCtrl", ["$scope", e]).controller("CheckboxCtrl", ["$scope", t]).controller("RadioCtrl", ["$scope", a]).controller("FormCtrl", ["$scope", n]).controller("MaterialAutocompleteCtrl", ["$scope", "$timeout", "$q", "$log", o]).controller("MaterialDatepickerCtrl", ["$scope", i]).controller("DatepickerDemoCtrl", ["$scope", r]).controller("TimepickerDemoCtrl", ["$scope", s]).controller("TypeaheadCtrl", ["$scope", l]).controller("RatingDemoCtrl", ["$scope", c])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.ui.form").directive("uiRangeSlider", e).directive("uiSpinner", t).directive("uiWizardForm", a)
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.ui.form.validation").controller("FormConstraintsCtrl", ["$scope", e]).controller("MaterialLoginCtrl", ["$scope", t]).controller("MaterialSignUpCtrl", ["$scope", a]).controller("SigninCtrl", ["$scope", n]).controller("SignupCtrl", ["$scope", o])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.ui.form").controller("WizardCtrl", ["$scope", "$q", "$timeout", "WizardHandler", e])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.layout").directive("uiPreloader", ["$rootScope", e])
}(),
function() {
  function e() {
...
function() {
  ...
  angular.module("BackEndApp.layout").directive("toggleNavCollapsedMin", ["$rootScope", e]).directive("collapseNav", t).directive("highlightActive", a).directive("toggleOffCanvas", n)
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.page").controller("invoiceCtrl", ["$scope", "$window", e]).controller("authCtrl", ["$scope", "$window", "$location", t])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.page").directive("customPage", e)
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.table").controller("TableCtrl", ["$scope", "$filter", e])
}(),
function() {
  "use strict";
  ...
  angular.module("BackEndApp.ui").controller("ChipsBasicDemoCtrl", e).controller("DialogDemo", ["$scope", "$mdDialog", t]).controller("TabsDemo", ["$scope", "$log", n]).controller("ProgressCircularDemo", ["$scope", "$interval", o]).controller("ProgressLinearDemo", ["$scope", "$interval", i]).controller("ToastDemo", ["$scope", "$mdToast", "$document", r]).controller("ToastCustomDemo", ["$scope", "$mdToast", s]).controller("TooltipDemo", ["$scope", l]).controller("SubheaderDemo", ["$scope", c]).controller("SelectDemo", u)
}(),
function() {
  "use strict";
...
function() {
  ...
  angular.module("BackEndApp.ui").directive("uiWave", e).directive("uiTime", t).directive("uiNotCloseOnClick", a).directive("slimScroll", n)
}();
